...
public class HomeFollowedHoovFragment extends ListFragment implements OnRefreshListener {
	...
	public static final HomeFollowedHoovFragment newInstance(String message,Context context, String comp, String cit,String id) {
		HomeFollowedHoovFragment f = new HomeFollowedHoovFragment(context,comp,cit,id);
	...
	public HomeFollowedHoovFragment(Context context, String comp, String cit, String id) {
