...
public class CommentActivity extends Activity implements OnClickListener{
	...
	public class SubmitHoovAsyncTask extends AsyncTask<HoovInsertParams, Void, Boolean>{
		...
		protected void onPreExecute(){
			pDialog = ProgressDialog.show(CommentActivity.this, "", "Hooving..",true);
		}
		@Override
		protected Boolean doInBackground(HoovInsertParams... params) {
			SharedPreferences preferences = CommentActivity.this.getSharedPreferences("hoov_tmp", 0);
			...
			Intent mServiceIntent = new Intent(CommentActivity.this, SaveOfflineHoovService.class);
			//mServiceIntent.putExtra("hoovText", hoovText.getText().toString());
			getApplicationContext().startService(mServiceIntent);

			Intent intent = new Intent(CommentActivity.this,HomeActivityNew.class);
	...
	public void onClick(View v) {
		...
		if(v.getId()== R.id.button1) {
			...
			Intent openMainActivity= new Intent(CommentActivity.this, HoovDetailsActivity.class);
