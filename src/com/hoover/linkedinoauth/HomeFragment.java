...
public class HomeFragment extends ListFragment implements OnRefreshListener {
	...
	public static final HomeFragment newInstance(String message,Context context, String comp, String cit) {
		HomeFragment f = new HomeFragment(context,comp,cit);
	...
	public HomeFragment(Context context, String comp, String cit) {
