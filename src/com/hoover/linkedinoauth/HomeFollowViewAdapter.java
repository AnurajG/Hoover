...
public class HomeFollowViewAdapter extends RecyclerView
.Adapter<HomeFollowViewAdapter
.DataObjectHolder> {
	...
	public HomeFollowViewAdapter(ArrayList<HoovChapter> myDataset, Context mContext, String id) {
		mDataset = myDataset;
		context=mContext;
		currentuserId=id;
		//pHoov=parentHoov;
